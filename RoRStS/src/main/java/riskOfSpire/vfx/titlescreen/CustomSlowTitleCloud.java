...
public class CustomSlowTitleCloud {
    private Texture IMG = TextureLoader.getTexture("riskOfSpireResources/images/vfx/CloudVfx2.png");
    private float posy;
    private float posx;
    private float rotation;

    public CustomSlowTitleCloud(float StartingPos) {
        Random r = new Random();
        this.posx = StartingPos;
        this.posy = Settings.HEIGHT / 2 + r.nextFloat() * 100.0F * Settings.scale - 50.0F * Settings.scale;
    ...
    public void update() {
        ...
        this.posx += Gdx.graphics.getDeltaTime() * Settings.scale * 250F;
    }
