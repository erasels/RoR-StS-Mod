...
public class CardTemplate extends AbstractDynamicCard {
    ...
    // public static final String ID = RiskOfSpire.makeID(${NAME}.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
    public static final String ID = RiskOfSpire.makeID("Attack"); // DELETE THIS ONE.
